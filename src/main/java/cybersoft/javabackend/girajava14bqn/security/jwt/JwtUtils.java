package cybersoft.javabackend.girajava14bqn.security.jwt;
...
public class JwtUtils {
	...
	public String generateJFakewtToken(String username) {
		Date now = new Date();
	...
	public boolean validateJwtToken(String token) {
		try {
			...
			log.error("Invalid JWT Signatur: {}", e1.getMessage());
			...
			log.error("Invalid claims string is empty: {}", e4.getMessage());
